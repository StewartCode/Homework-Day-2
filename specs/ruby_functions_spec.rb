...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_cube()
     volume_of_cube = length_of_side(5)
     assert_equal(125,volume_of_cube)
  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
     volume_of_sphere = radius_of_sphere(4)
     assert_equal(267.03537555515,volume_of_sphere)
  end
  ...
  def test_convert_to_celsius()
     celsius = farenheit(80)
     assert_equal(26,celsius)
  end
